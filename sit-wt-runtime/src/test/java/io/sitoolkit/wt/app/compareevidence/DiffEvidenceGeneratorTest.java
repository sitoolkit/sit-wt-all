...
public class DiffEvidenceGeneratorTest {
  ...
  private static final SitLogger LOG = SitLoggerFactory.getLogger(DiffEvidenceGeneratorTest.class);
  ...
  EvidenceDir targetDir =
      EvidenceDir.getInstance("target/evidence_" + RandomStringUtils.randomNumeric(4));
  ...
  public void setUp() throws IOException {
    ...
    FileUtils.copyDirectoryToDirectory(new File("compareevidence/target/css"), targetDir.getDir());
    FileUtils.copyDirectoryToDirectory(new File("compareevidence/target/img"), targetDir.getDir());
  ...
  public void testGenerateWithoutScreenshot() throws IOException {
    ...
    FileUtils.copyFileToDirectory(new File("compareevidence/target/ABCTestScript.xlsx_001.html"),
        targetDir.getDir());

    boolean result = generator.generate(baseDir, targetDir, false);

    assertThat("evidence comparing result", result, is(true));
    assertThat("マスク版エビデンス生成", new File(evidencePath, "mask_ABCTestScript.xlsx_001.html").exists(),
        is(false));
    assertThat("比較エビデンス生成", new File(evidencePath, "comp_ABCTestScript.xlsx_001.html").exists(),
        is(true));
    assertThat("比較（マスク版）エビデンス生成",
        new File(evidencePath, "comp_mask_ABCTestScript.xlsx_001.html").exists(), is(false));
  ...
  public void testGenerateWithScreenshotMatch() throws IOException {
    ...
    FileUtils.copyFileToDirectory(new File("compareevidence/target/ABCTestScript.xlsx_002.html"),
        targetDir.getDir());

    boolean result = generator.generate(baseDir, targetDir, true);

    assertThat("evidence comparing result", result, is(true));
    assertThat("マスク版エビデンス生成", new File(evidencePath, "mask_ABCTestScript.xlsx_002.html").exists(),
        is(false));
    assertThat("比較エビデンス生成", new File(evidencePath, "comp_ABCTestScript.xlsx_002.html").exists(),
        is(true));
    assertThat("比較（マスク版）エビデンス生成",
        new File(evidencePath, "comp_mask_ABCTestScript.xlsx_002.html").exists(), is(false));
    assertThat("不一致スクリーンショットに対する比較エビデンス未生成",
  ...
  public void testGenerateWithScreenshotUnmatch() throws IOException {
    ...
    FileUtils.copyFileToDirectory(new File("compareevidence/target/ABCTestScript.xlsx_003.html"),
        targetDir.getDir());

    boolean result = generator.generate(baseDir, targetDir, true);

    assertThat("evidence comparing result", result, is(false));
    assertThat("マスク版エビデンス生成", new File(evidencePath, "mask_ABCTestScript.xlsx_003.html").exists(),
        is(false));
    assertThat("比較エビデンス生成", new File(evidencePath, "comp_ABCTestScript.xlsx_003.html").exists(),
        is(true));
    assertThat("比較（マスク版）エビデンス生成",
        new File(evidencePath, "comp_mask_ABCTestScript.xlsx_003.html").exists(), is(false));
    assertThat("不一致スクリーンショットに対する比較エビデンス未生成",
  ...
  public void testGenerateWithScreenshotWithMaskMatch() throws IOException {
    ...
    FileUtils.copyFileToDirectory(new File("compareevidence/target/ABCTestScript.xlsx_004.html"),
        targetDir.getDir());

    boolean result = generator.generate(baseDir, targetDir, true);

    assertThat("evidence comparing result", result, is(true));
    assertThat("マスク版エビデンス生成", new File(evidencePath, "mask_ABCTestScript.xlsx_004.html").exists(),
        is(true));
  ...
  public void testGenerateWithScreenshotWithMaskMatchUnmach() throws IOException {
    ...
    FileUtils.copyFileToDirectory(new File("compareevidence/target/ABCTestScript.xlsx_005.html"),
        targetDir.getDir());

    boolean result = generator.generate(baseDir, targetDir, true);

    assertThat("evidence comparing result", result, is(false));
    assertThat("マスク版エビデンス生成", new File(evidencePath, "mask_ABCTestScript.xlsx_005.html").exists(),
        is(true));
