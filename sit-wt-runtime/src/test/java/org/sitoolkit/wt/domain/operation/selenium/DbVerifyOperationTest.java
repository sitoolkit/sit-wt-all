...
public class DbVerifyOperationTest extends SitTesterTestBase {
    ...
    public void test002() {
        try {
            ...
            assertThat(errMsg[1], is("org.sitoolkit.wt.infra.VerifyException: <br/>"));
    ...
    public void test003() {
        try {
            ...
            String[] errMsg = splitErrMsg(e.getMessage());
            assertThat(errMsg[1], is("org.sitoolkit.wt.infra.TestException:"
    ...
    public void test005() {
        try {
            ...
            String[] errMsg = splitErrMsg(e.getMessage());
            assertThat(errMsg[1],
                    is("org.sitoolkit.wt.infra.TestException: org.springframework.dao.InvalidDataAccessApiUsageException:"
    ...
    public void test006() {
        try {
            ...
            assertThat(errMsg[1], is(
                    "org.sitoolkit.wt.infra.TestException: org.springframework.jdbc.BadSqlGrammarException: PreparedStatementCallback; bad SQL grammar [SELECT COL1, COL2 FROM TAB1 ID = ?]; nested exception is java.sql.SQLSyntaxErrorException: Syntax error: Encountered \"=\" at line 1, column 32."));
        }
    }
    ...
    public void test007() {
        try {
            ...
            String[] errMsg = splitErrMsg(e.getMessage());
            assertThat(errMsg[1],
                    is("org.sitoolkit.wt.infra.TestException: java.io.FileNotFoundException: File '"
