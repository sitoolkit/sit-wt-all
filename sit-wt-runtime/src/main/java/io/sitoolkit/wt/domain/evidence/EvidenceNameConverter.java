...
public class EvidenceNameConverter {
  ...
  public static String buildScreenshotFileName(String scriptName, String caseNo, String testStepNo,
      String itemName, String timing) {

    String evidenceBase = EvidenceNameConverter.caseNo2evidenceBase(scriptName, caseNo);
    return evidenceBase + "_" + StrUtils.sanitizeMetaCharacter(
        StringUtils.join(new String[] {testStepNo, itemName, timing}, "_")) + ".png";
  }
