...
public class SitWtApplication2 extends Application {

  private static final SitLogger LOG = SitLoggerFactory.getLogger(SitWtApplication2.class);
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    // 次のステップで作られるスレッドが残り、"x"ボタンを押した時のプロセスの終了を阻害する。
    // ここをコメントアウトすれば、"x"ボタンを押した時にプロセスは終了する。
