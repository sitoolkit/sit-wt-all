...
public class FileSystemWatchService {
  ...
  void watch() {
    ...
    try {
      ...
      for (WatchEvent<?> watchEvent : watchKey.pollEvents()) {
        ...
        LOG.debug("app.watchParams",
            new Object[] {watchKey, watchEvent.kind(), watchEvent.context(), eventSourcePath});
  ...
  void delete(Path eventTargetPath, FileTreeItem eventSourceItem) {
    ...
    LOG.debug("app.deletePath", new Object[] {eventTargetPath, eventTargetItem, removingWatchKey});
  }
}
