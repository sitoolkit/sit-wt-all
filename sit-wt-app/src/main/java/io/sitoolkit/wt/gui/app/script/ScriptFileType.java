...
public enum ScriptFileType {
  ...
  CSV_UTF8("test script (csv/UTF-8)", true, StandardCharsets.UTF_8, true, "*.csv"),

  CSV_UTF8_NO_BOM("test script (csv/UTF-8(no-bom))", true, StandardCharsets.UTF_8, false, "*.csv"),

  CSV_SJIS("test script (csv/Shift-JIS)", true, Charset.forName("Windows-31J"), false, "*.csv"),;
  ...
  private ScriptFileType(String description, boolean isBinaryFile, Charset charset, boolean hasBom,
      String... extentions) {
